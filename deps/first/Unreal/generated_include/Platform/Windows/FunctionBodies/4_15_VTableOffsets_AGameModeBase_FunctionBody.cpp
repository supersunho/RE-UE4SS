...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("PreLogin_1"), 0x6C8);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("Login_1"), 0x6D8);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("InitNewPlayer_1"), 0x750);
}
