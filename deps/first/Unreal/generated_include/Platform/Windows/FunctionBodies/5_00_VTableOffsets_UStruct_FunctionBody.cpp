...
{
    UStruct::VTableLayoutMap.emplace(STR("SerializeBin_1"), 0x2D0);
}
...
{
    UStruct::VTableLayoutMap.emplace(STR("SerializeTaggedProperties_1"), 0x2E0);
}
...
{
    UStruct::VTableLayoutMap.emplace(STR("GetAuthoredNameForField_1"), 0x330);
}
