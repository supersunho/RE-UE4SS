...
{
    UStruct::VTableLayoutMap.emplace(STR("SerializeBin_1"), 0x2D8);
}
...
{
    UStruct::VTableLayoutMap.emplace(STR("SerializeTaggedProperties_1"), 0x2E8);
}
...
{
    UStruct::VTableLayoutMap.emplace(STR("GetAuthoredNameForField_1"), 0x338);
}
