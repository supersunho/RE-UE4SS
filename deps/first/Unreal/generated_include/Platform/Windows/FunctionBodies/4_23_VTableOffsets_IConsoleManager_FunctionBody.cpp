...
{
    IConsoleManager::VTableLayoutMap.emplace(STR("RegisterConsoleVariableSink_Handle"), 0x48);
}
...
{
    IConsoleManager::VTableLayoutMap.emplace(STR("ForEachConsoleObjectThatStartsWith"), 0xB0);
}
