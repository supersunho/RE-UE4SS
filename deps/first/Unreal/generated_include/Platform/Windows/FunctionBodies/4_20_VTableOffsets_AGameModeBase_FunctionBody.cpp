...
if (auto it = AGameModeBase::VTableLayoutMap.find(STR("PreLogin_1")); it == AGameModeBase::VTableLayoutMap.end())
{
    AGameModeBase::VTableLayoutMap.emplace(STR("PreLogin_1"), 0x710);
}
...
if (auto it = AGameModeBase::VTableLayoutMap.find(STR("Login_1")); it == AGameModeBase::VTableLayoutMap.end())
{
    AGameModeBase::VTableLayoutMap.emplace(STR("Login_1"), 0x720);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("SpawnPlayerController_1"), 0x740);
}
...
if (auto it = AGameModeBase::VTableLayoutMap.find(STR("InitNewPlayer_1")); it == AGameModeBase::VTableLayoutMap.end())
{
    AGameModeBase::VTableLayoutMap.emplace(STR("InitNewPlayer_1"), 0x7A8);
}
