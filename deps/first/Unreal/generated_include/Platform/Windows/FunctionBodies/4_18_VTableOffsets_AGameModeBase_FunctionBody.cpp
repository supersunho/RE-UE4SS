...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("PreLogin_1"), 0x6E8);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("Login_1"), 0x6F8);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("InitNewPlayer_1"), 0x770);
}
