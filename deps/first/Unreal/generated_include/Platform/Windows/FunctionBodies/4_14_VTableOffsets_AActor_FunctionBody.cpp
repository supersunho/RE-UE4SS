...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetPriority_1"), 0x348);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetDormancy_1"), 0x360);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("IsNetRelevantFor_1"), 0x3F8);
}
