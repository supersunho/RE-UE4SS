...
if (auto it = AGameMode::VTableLayoutMap.find(STR("PreLogin_1")); it == AGameMode::VTableLayoutMap.end())
{
    AGameMode::VTableLayoutMap.emplace(STR("PreLogin_1"), 0x710);
}
...
if (auto it = AGameMode::VTableLayoutMap.find(STR("Login_1")); it == AGameMode::VTableLayoutMap.end())
{
    AGameMode::VTableLayoutMap.emplace(STR("Login_1"), 0x720);
}
...
if (auto it = AGameMode::VTableLayoutMap.find(STR("InitNewPlayer_1")); it == AGameMode::VTableLayoutMap.end())
{
    AGameMode::VTableLayoutMap.emplace(STR("InitNewPlayer_1"), 0x818);
}
