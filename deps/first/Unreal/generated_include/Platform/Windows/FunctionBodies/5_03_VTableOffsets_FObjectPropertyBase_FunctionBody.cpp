...
{
    FObjectPropertyBase::VTableLayoutMap.emplace(STR("GetCPPTypeCustom"), 0x178);
}
...
{
    FObjectPropertyBase::VTableLayoutMap.emplace(STR("LoadObjectPropertyValue"), 0x180);
}
...
{
    FObjectPropertyBase::VTableLayoutMap.emplace(STR("GetObjectPtrPropertyValue"), 0x188);
}
...
{
    FObjectPropertyBase::VTableLayoutMap.emplace(STR("GetObjectPropertyValue"), 0x190);
}
...
{
    FObjectPropertyBase::VTableLayoutMap.emplace(STR("GetObjectPropertyValue_InContainer"), 0x198);
}
...
{
    FObjectPropertyBase::VTableLayoutMap.emplace(STR("SetObjectPropertyValue"), 0x1A0);
}
...
{
    FObjectPropertyBase::VTableLayoutMap.emplace(STR("SetObjectPtrPropertyValue"), 0x1A8);
}
...
{
    FObjectPropertyBase::VTableLayoutMap.emplace(STR("AllowObjectTypeReinterpretationTo"), 0x1C8);
}
