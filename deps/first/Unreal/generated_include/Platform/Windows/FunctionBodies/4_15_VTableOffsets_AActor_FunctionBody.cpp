...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetPriority_1"), 0x350);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetDormancy_1"), 0x368);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("IsNetRelevantFor_1"), 0x400);
}
