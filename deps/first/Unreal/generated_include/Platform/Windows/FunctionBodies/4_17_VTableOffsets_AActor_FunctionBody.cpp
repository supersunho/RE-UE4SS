...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetPriority_1"), 0x380);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetDormancy_1"), 0x398);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("IsNetRelevantFor_1"), 0x430);
}
