...
{
    IConsoleManager::VTableLayoutMap.emplace(STR("RegisterConsoleVariableBitRef"), 0x28);
}

if (auto it = IConsoleManager::VTableLayoutMap.find(STR("CallAllConsoleVariableSinks")); it == IConsoleManager::VTableLayoutMap.end())
{
    IConsoleManager::VTableLayoutMap.emplace(STR("CallAllConsoleVariableSinks"), 0x30);
}
...
{
    IConsoleManager::VTableLayoutMap.emplace(STR("RegisterConsoleVariableSink_Handle"), 0x38);
}
