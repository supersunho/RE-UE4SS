...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetPriority_1"), 0x370);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetDormancy_1"), 0x388);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("IsNetRelevantFor_1"), 0x420);
}
