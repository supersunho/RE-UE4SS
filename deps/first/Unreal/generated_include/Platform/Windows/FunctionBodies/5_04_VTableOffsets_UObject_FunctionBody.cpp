...
{
    UObject::VTableLayoutMap.emplace(STR("PreSaveRoot_1"), 0x68);
}
...
{
    UObject::VTableLayoutMap.emplace(STR("PostSaveRoot_1"), 0x78);
}
...
{
    UObject::VTableLayoutMap.emplace(STR("PreSave_1"), 0x88);
}
...
{
    UObject::VTableLayoutMap.emplace(STR("Serialize_1"), 0xD0);
}
...
{
    UObject::VTableLayoutMap.emplace(STR("PostDuplicate_1"), 0x100);
}
...
if (auto it = UObject::VTableLayoutMap.find(STR("GetAssetRegistryTags_1")); it == UObject::VTableLayoutMap.end())
{
    UObject::VTableLayoutMap.emplace(STR("GetAssetRegistryTags_1"), 0x1C0);
}
