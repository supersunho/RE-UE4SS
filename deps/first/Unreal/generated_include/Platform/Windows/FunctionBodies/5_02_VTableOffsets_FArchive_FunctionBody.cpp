...
{
    FArchive::VTableLayoutMap.emplace(STR("AttachBulkData_1"), 0x198);
}
...
{
    FArchive::VTableLayoutMap.emplace(STR("DetachBulkData_1"), 0x1A8);
}
