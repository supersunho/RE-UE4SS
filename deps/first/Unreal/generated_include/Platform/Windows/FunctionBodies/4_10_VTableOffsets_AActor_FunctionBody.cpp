...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetPriority"), 0x2F0);
}

if (auto it = AActor::VTableLayoutMap.find(STR("GetNetPriority_1")); it == AActor::VTableLayoutMap.end())
{
    AActor::VTableLayoutMap.emplace(STR("GetNetPriority_1"), 0x2F8);
}

if (auto it = AActor::VTableLayoutMap.find(STR("GetNetDormancy")); it == AActor::VTableLayoutMap.end())
{
    AActor::VTableLayoutMap.emplace(STR("GetNetDormancy"), 0x300);
}

if (auto it = AActor::VTableLayoutMap.find(STR("GetNetDormancy_1")); it == AActor::VTableLayoutMap.end())
{
    AActor::VTableLayoutMap.emplace(STR("GetNetDormancy_1"), 0x308);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("IsNetRelevantFor"), 0x388);
}

if (auto it = AActor::VTableLayoutMap.find(STR("IsNetRelevantFor_1")); it == AActor::VTableLayoutMap.end())
{
    AActor::VTableLayoutMap.emplace(STR("IsNetRelevantFor_1"), 0x390);
}
