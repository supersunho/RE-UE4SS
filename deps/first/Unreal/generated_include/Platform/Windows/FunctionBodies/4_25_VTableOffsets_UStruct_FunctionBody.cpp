...
{
    UStruct::VTableLayoutMap.emplace(STR("SerializeBin_1"), 0x288);
}
...
{
    UStruct::VTableLayoutMap.emplace(STR("SerializeTaggedProperties_1"), 0x298);
}
...
{
    UStruct::VTableLayoutMap.emplace(STR("GetAuthoredNameForField_1"), 0x2E0);
}
