...
{
    UObject::VTableLayoutMap.emplace(STR("PreSaveRoot_1"), 0x60);
}
...
{
    UObject::VTableLayoutMap.emplace(STR("PostSaveRoot_1"), 0x70);
}
...
{
    UObject::VTableLayoutMap.emplace(STR("PreSave_1"), 0x80);
}
...
{
    UObject::VTableLayoutMap.emplace(STR("Serialize_1"), 0xC8);
}
