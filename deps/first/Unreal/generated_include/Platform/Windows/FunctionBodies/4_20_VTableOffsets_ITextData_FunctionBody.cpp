...
if (auto it = ITextData::VTableLayoutMap.find(STR("OwnsLocalizedString")); it == ITextData::VTableLayoutMap.end())
{
    ITextData::VTableLayoutMap.emplace(STR("OwnsLocalizedString"), 0x8);
}
