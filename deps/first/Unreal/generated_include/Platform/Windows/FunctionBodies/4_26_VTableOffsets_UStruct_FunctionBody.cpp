...
{
    UStruct::VTableLayoutMap.emplace(STR("SerializeBin_1"), 0x290);
}
...
{
    UStruct::VTableLayoutMap.emplace(STR("SerializeTaggedProperties_1"), 0x2A0);
}
...
{
    UStruct::VTableLayoutMap.emplace(STR("GetAuthoredNameForField_1"), 0x2E8);
}
