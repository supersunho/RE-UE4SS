...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("PreLogin_1"), 0x708);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("Login_1"), 0x718);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("InitNewPlayer_1"), 0x790);
}
