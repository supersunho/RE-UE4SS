...
{
    ULocalPlayer::VTableLayoutMap.emplace(STR("GetSlateUser_1"), 0x2C8);
}
...
{
    ULocalPlayer::VTableLayoutMap.emplace(STR("PlayerAdded"), 0x2E0);
}

if (auto it = ULocalPlayer::VTableLayoutMap.find(STR("PlayerAdded_1")); it == ULocalPlayer::VTableLayoutMap.end())
{
    ULocalPlayer::VTableLayoutMap.emplace(STR("PlayerAdded_1"), 0x2E8);
}
