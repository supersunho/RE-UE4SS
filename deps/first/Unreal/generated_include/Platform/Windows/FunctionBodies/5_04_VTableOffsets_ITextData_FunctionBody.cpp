...
{
    ITextData::VTableLayoutMap.emplace(STR("GetTextHistory"), 0x48);
}

if (auto it = ITextData::VTableLayoutMap.find(STR("GetMutableTextHistory")); it == ITextData::VTableLayoutMap.end())
{
    ITextData::VTableLayoutMap.emplace(STR("GetMutableTextHistory"), 0x50);
}
