...
{
    UEngine::VTableLayoutMap.emplace(STR("GetTimeBetweenGarbageCollectionPasses"), 0x390);
}
...
{
    UEngine::VTableLayoutMap.emplace(STR("CancelPending_1"), 0x500);
}

if (auto it = UEngine::VTableLayoutMap.find(STR("CancelPending_2")); it == UEngine::VTableLayoutMap.end())
{
    UEngine::VTableLayoutMap.emplace(STR("CancelPending_2"), 0x508);
}
