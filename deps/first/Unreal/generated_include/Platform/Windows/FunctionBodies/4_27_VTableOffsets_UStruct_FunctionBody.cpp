...
{
    UStruct::VTableLayoutMap.emplace(STR("GetAuthoredNameForField"), 0x2E8);
}

if (auto it = UStruct::VTableLayoutMap.find(STR("GetAuthoredNameForField_1")); it == UStruct::VTableLayoutMap.end())
{
    UStruct::VTableLayoutMap.emplace(STR("GetAuthoredNameForField_1"), 0x2F0);
}
