...
{
    UEngine::VTableLayoutMap.emplace(STR("NetworkRemapPath"), 0x3B0);
}

if (auto it = UEngine::VTableLayoutMap.find(STR("NetworkRemapPath_1")); it == UEngine::VTableLayoutMap.end())
{
    UEngine::VTableLayoutMap.emplace(STR("NetworkRemapPath_1"), 0x3B8);
}
