...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetPriority_1"), 0x328);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetDormancy_1"), 0x340);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("IsNetRelevantFor_1"), 0x3D8);
}
