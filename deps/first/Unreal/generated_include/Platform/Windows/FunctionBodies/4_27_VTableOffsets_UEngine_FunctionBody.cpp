...
{
    UEngine::VTableLayoutMap.emplace(STR("NetworkRemapPath"), 0x410);
}

if (auto it = UEngine::VTableLayoutMap.find(STR("NetworkRemapPath_1")); it == UEngine::VTableLayoutMap.end())
{
    UEngine::VTableLayoutMap.emplace(STR("NetworkRemapPath_1"), 0x418);
}

if (auto it = UEngine::VTableLayoutMap.find(STR("NetworkRemapPath_2")); it == UEngine::VTableLayoutMap.end())
{
    UEngine::VTableLayoutMap.emplace(STR("NetworkRemapPath_2"), 0x420);
}
