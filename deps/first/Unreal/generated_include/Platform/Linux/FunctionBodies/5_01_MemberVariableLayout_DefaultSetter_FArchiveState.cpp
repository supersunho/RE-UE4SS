if (auto it = FArchiveState::MemberOffsets.find(STR("_vptr$FArchiveState")); it == FArchiveState::MemberOffsets.end())
{
    FArchiveState::MemberOffsets.emplace(STR("_vptr$FArchiveState"), 0x00);
}

if (auto it = FArchiveState::MemberOffsets.find(STR("ActiveFPLB")); it == FArchiveState::MemberOffsets.end())
{
    FArchiveState::MemberOffsets.emplace(STR("ActiveFPLB"), 0x08);
}

if (auto it = FArchiveState::MemberOffsets.find(STR("InlineFPLB")); it == FArchiveState::MemberOffsets.end())
{
    FArchiveState::MemberOffsets.emplace(STR("InlineFPLB"), 0x10);
}
...
if (auto it = FArchiveState::MemberOffsets.find(STR("CookData")); it == FArchiveState::MemberOffsets.end())
{
    FArchiveState::MemberOffsets.emplace(STR("CookData"), 0x70);
}
...
if (auto it = FArchiveState::MemberOffsets.find(STR("SerializedPropertyChain")); it == FArchiveState::MemberOffsets.end())
{
    FArchiveState::MemberOffsets.emplace(STR("SerializedPropertyChain"), 0x80);
}
