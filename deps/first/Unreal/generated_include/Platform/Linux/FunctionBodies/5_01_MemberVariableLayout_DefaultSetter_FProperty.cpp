...
{
    FProperty::MemberOffsets.emplace(STR("ElementSize"), 0x38);
}
...
if (auto it = FProperty::MemberOffsets.find(STR("BlueprintReplicationCondition")); it == FProperty::MemberOffsets.end())
{
    FProperty::MemberOffsets.emplace(STR("BlueprintReplicationCondition"), 0x4a);
}
