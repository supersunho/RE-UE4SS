...
if (auto it = UStruct::MemberOffsets.find(STR("UnversionedGameSchema")); it == UStruct::MemberOffsets.end())
{
    UStruct::MemberOffsets.emplace(STR("UnversionedGameSchema"), 0xa8);
}
