...
\
    ...
    inline static const TCHAR* StaticPackage() { return STR("/Script/") STR(#ModuleName); }   \
    inline static const TCHAR* StaticClassName() { return (STR(#ClassName) + 1); } \
public: \
...
{ \
    ...
    { \
        auto ClassName_ = UEStringType{StaticClassName()}; \
        ClassName_.erase(0, 0); \
        auto FullName = UEStringType(StaticPackage()) + STR(".") + ClassName_; \
...
namespace RC::Unreal::Internal
{
    ...
    {
    protected:
        UClassRegistrar(RC::Unreal::UClass** OutStaticClass, const TCHAR* ClassName, const TCHAR* PackageName)
        {
            (void)OutStaticClass;
            (void)ClassName;
            (void)PackageName;
    ...
    {
    protected:
        FFieldClassRegistrar(RC::Unreal::FFieldClassVariant* OutStaticClass, const TCHAR* ClassName)
        {
            (void)OutStaticClass;
            (void)ClassName;
        }
