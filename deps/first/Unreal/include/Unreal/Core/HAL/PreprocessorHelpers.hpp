...
#define PREPROCESSOR_JOIN3(x, y, z) PREPROCESSOR_JOIN(PREPROCESSOR_JOIN(x, y), z)
...
#define COMPILED_PLATFORM_HEADER(Suffix) PREPROCESSOR_TO_STRING(PREPROCESSOR_JOIN(Unreal/Core/PLATFORM_HEADER_NAME/PLATFORM_HEADER_NAME, Suffix))
#endif
