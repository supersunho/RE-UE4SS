...
#include <Unreal/Core/Traits/IsCharEncodingSimplyConvertibleTo.hpp>
#include <Unreal/Core/Traits/IsCharType.hpp>
#include <Unreal/Core/Traits/IsFixedWidthCharEncoding.hpp>
