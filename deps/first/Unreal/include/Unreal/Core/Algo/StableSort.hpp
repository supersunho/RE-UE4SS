...
#include <Unreal/Core/Algo/BinarySearch.hpp>
#include <Unreal/Core/Algo/Rotate.hpp>
#include <Unreal/Core/Templates/IdentityFunctor.hpp>
#include <Unreal/Core/Templates/Invoke.hpp>
#include <Unreal/Core/Templates/Less.hpp>
#include <Unreal/Core/Templates/UnrealTemplate.hpp> // For GetData, GetNum, Swap
