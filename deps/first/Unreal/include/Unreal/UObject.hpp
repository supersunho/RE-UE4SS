...
#include <MemberVariableLayout_HeaderWrapper_UObjectBase.hpp>
    ...
    public:
        ...
        auto DeferredRegister(class UClass* UClassStaticClass, const UECharType* PackageName, const UECharType* Name) -> void;
    ...
    public:
         ...
         */
        inline auto GetName() const -> UEStringType
        {
         ...
         */
        auto GetPathName(UObject* StopOuter = nullptr) const -> UEStringType;

        /**
         * Returns the full name of the object in form Class Package.Outer:ObjectName
         */
        auto GetFullName(UObject* StopOuter = nullptr) const -> UEStringType;

        auto GetPathName(UObject* StopOuter, UEStringType& ResultString) const -> void;
