...
namespace RC::Unreal::UObjectGlobals
{
    ...
    RC_UE_API UObject* FindObject(UClass* Class, UObject* InOuter, UEStringViewType InName, bool bExactClass = false, ObjectSearcher* = nullptr);
    ...
    RC_UE_API UObject* FindObject(ObjectSearcher&, UClass* Class, UObject* InOuter, UEStringViewType InName, bool bExactClass = false);
    ...
    RC_UE_API auto StaticFindObject_InternalSlow(UClass* Object, UObject* ChunkIndex, const TCHAR* OrigInName, bool bExactClass = false) -> UObject*;

    template<UObjectPointerDerivative ObjectType = UObject*>
    auto StaticFindObject(UClass* ObjectClass, UObject* InObjectPackage, const TCHAR* OrigInName, bool bExactClass = false) -> ObjectType
    {
        return static_cast<ObjectType>(FindObject(ObjectClass, InObjectPackage, OrigInName, bExactClass));
    }
    template<UObjectPointerDerivative ObjectType = UObject*>
    auto StaticFindObject(UClass* ObjectClass, UObject* InObjectPackage, UEStringViewType OrigInName, bool bExactClass = false) -> ObjectType
    {
        return static_cast<ObjectType>(FindObject(ObjectClass, InObjectPackage, OrigInName.data(), bExactClass));
    }

    template<UObjectPointerDerivative ObjectType = UObject*>
    auto StaticFindObject(UClass* ObjectClass, UObject* InObjectPackage, const UEStringType& OrigInName, bool bExactClass = false) -> ObjectType
    {
    ...
    RC_UE_API auto FindFirstOf(const TCHAR* ClassName) -> UObject*;
    RC_UE_API auto FindFirstOf(UEStringViewType ClassName) -> UObject*;
    RC_UE_API auto FindFirstOf(const UEStringType& ClassName) -> UObject*;
    ...
    RC_UE_API auto FindAllOf(const TCHAR* ClassName, std::vector<UObject*>& OutStorage) -> void;
    RC_UE_API auto FindAllOf(UEStringViewType ClassName, std::vector<UObject*>& OutStorage) -> void;
    RC_UE_API auto FindAllOf(const UEStringType& ClassName, std::vector<UObject*>& OutStorage) -> void;
    ...
    RC_UE_API auto FindObjects(size_t NumObjectsToFind, const TCHAR* ClassName, const TCHAR* ObjectShortName, std::vector<UObject*>& OutStorage, int32 RequiredFlags = {}, int32 BannedFlags = {}, bool bExactClass = true) -> void;
    ...
    RC_UE_API auto FindObject(const TCHAR* ClassName, const TCHAR* ObjectShortName, int32 RequiredFlags = {}, int32 BannedFlags = {}) -> UObject*;
    ...
    RC_UE_API auto FindObjects(const TCHAR* ClassName, const TCHAR* ObjectShortName, std::vector<UObject*>& OutStorage, int32 RequiredFlags = {}, int32 BannedFlags = {}, bool bExactClass = true) -> void;
    ...
    RC_UE_API auto RegisterHook(const UEStringType& FunctionFullNameNoType, UnrealScriptFunctionCallable, UnrealScriptFunctionCallable, void*) -> std::pair<int, int>;
    RC_UE_API auto UnregisterHook(class UFunction* Function, std::pair<int, int>) -> void;
    RC_UE_API auto UnregisterHook(const UEStringType& FunctionFullNameNoType, std::pair<int, int>) -> void;
    // Custom Helpers -> END
}
