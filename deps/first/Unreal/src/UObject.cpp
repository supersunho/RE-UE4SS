...
namespace RC::Unreal
{
    ...
    RC_UE_API std::unordered_map<UEStringType, uint32_t> UObjectBase::VTableLayoutMap{};
    RC_UE_API std::unordered_map<UEStringType, uint32_t> UObjectBaseUtility::VTableLayoutMap{};
    RC_UE_API std::unordered_map<UEStringType, uint32_t> UObject::VTableLayoutMap{};
    ...
    auto UObjectBase::DeferredRegister(class UClass* UClassStaticClass, const UECharType* PackageName, const UECharType* Name) -> void
    {
        IMPLEMENT_UNREAL_VIRTUAL_WRAPPER(UObjectBase, DeferredRegister, void, PARAMS(const UClass*, const UECharType*, const UECharType*), ARGS(UClassStaticClass, PackageName, Name))
    }
    ...
    auto UObject::GetPathName(UObject* StopOuter) const -> UEStringType
    {
        UEStringType ResultName;
        GetPathName(StopOuter, ResultName);
        return ResultName;
    }

    auto UObject::GetPathName(UObject* StopOuter, UEStringType& ResultString) const -> void
    {
    ...
    auto UObject::GetFullName(UObject* StopOuter) const -> UEStringType
    {
        if (this == nullptr)
        {
            return STR("None");
